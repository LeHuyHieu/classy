...
$(window).resize(function () {
  ...
  if (win.width() <= 500) {
    let btn = $('#button-menu-mobile').html();
    $('body').append(btn);
  }
});

$(document).ready(function () {
  $(".icon-navbar__rps").click(function () {
    $(".header__block").toggleClass("d-block__rps");
  });
});
...
$(window).scroll(function () {
  var windowpos = $(window).scrollTop();
  if (windowpos >= 500) {
    $(".header__block").addClass("bg-white");
  } else {
    $(".header__block").removeClass("bg-white");
  }
});